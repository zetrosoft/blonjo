...
export default function MasterDataHub() {
  ...
  const cards = [
    {
      title: t('md_hub_item_title'),
      desc: t('md_hub_item_desc'),
      btnText: t('md_hub_item_btn'),
      icon: Package,
      path: '/master-data/item'
    },
    {
      title: t('md_hub_supplier_title'),
      desc: t('md_hub_supplier_desc'),
      btnText: t('md_hub_supplier_btn'),
      icon: Users,
      path: '/master-data/supplier'
    },
    {
      title: t('md_hub_customer_title'),
      desc: t('md_hub_customer_desc'),
      btnText: t('md_hub_customer_btn'),
      icon: User,
      path: '/master-data/customer'
    },
    {
      title: t('md_hub_uom_title'),
      desc: t('md_hub_uom_desc'),
        ...
        {cards.map((card, idx) => (
          ...
          >
            ...
            <CardHeader className="space-y-3 pb-3">
              <div className="p-2.5 bg-primary/10 text-primary w-fit rounded-lg transition-transform duration-300 group-hover:scale-105">
